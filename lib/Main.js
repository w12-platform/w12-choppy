...
class Main {
    ...
    parseArguments() {
        ...
        this.prog
            .command('add <ref>')
            .description('Install specified contracts version.')
        ...
        this.prog
            ...
            .option('-c, --custom <path>', 'Run script from specified directory.')
        ...
        this.prog
            .command('list')
            .description('Show list of contracts. By default print locally installed.')
            .option('-i, --installed', 'Show installed locally')
            .option('-a, --all', 'Show all available list')
            .option('-s, --source <url>', 'Specify custom source of contracts')
            .action(async (cmd) => {
                let list = [];
